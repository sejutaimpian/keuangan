        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class="card border-left-success shadow h-100">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  ...
                  <div class="h5 mb-0 font-weight-bold text-gray-800">Rp. <?= ($pemasukan_hari_ini == null) ? '0' : number_format($pemasukan_hari_ini['0'], 2, ',', '.'); ?></div>
                </div>
                <div class="col-auto">
            ...
            <div class="card-footer bg-success text-light">
              Total Pemasukan : Rp. <?php echo number_format($jumlahmasuk, 2, ',', '.'); ?>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class="card border-left-danger shadow h-100">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  ...
                  <div class="h5 mb-0 font-weight-bold text-gray-800">Rp. <?= ($pengeluaran_hari_ini == null) ? '0' : number_format($pengeluaran_hari_ini['0'], 2, ',', '.'); ?></div>
                </div>
                <div class="col-auto">
            ...
            <div class="card-footer bg-danger text-light">
              Total Pengeluaran : Rp. <?php echo number_format($jumlahkeluar, 2, ',', '.'); ?>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class="card border-left-info shadow h-100">
            ...
            <div class="card-footer bg-info text-light">
              Total Pengeluaran : Rp. <?= number_format($uang, 2, ',', '.'); ?>
            </div>
          </div>
        </div>
